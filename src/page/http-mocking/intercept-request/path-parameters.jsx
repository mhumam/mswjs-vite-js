...
const App = () => {
    ...
    const handleSubmit = useCallback(async () => {
        ...
        try {
            const response = await axios(`https://dummyjson.com/products/${input}`);
            setResult(response);
    ...
    return (
        <div className="content-section active" id="intercept-request">
            <h2 className="section-title">Path Parameters</h2>
                ...
                <Card title="Custom Value Params" variant="outlined">
                    <Form layout={'vertical'} form={form} initialValues={{ layout: 'vertical' }}>
                        <Form.Item label="Product ID">
                            <Input placeholder="input Product ID" onChange={handleInputChange} value={input} />
                        </Form.Item>
                    </Form>
                </Card>
